...
add regexp="(^|(.*\\.))osxapps\\.itunes\\.g\\.aaplimg\\.com\$" type=FWD forward-to=$dnsCN comment="CNListDomain:Apple"
...
add regexp="(^|(.*\\.))swallow-apple-com\\.v\\.aaplimg\\.com\$" type=FWD forward-to=$dnsCN comment="CNListDomain:Apple"
...
add regexp="(^|(.*\\.))weather-data\\.apple\\.com\\.akadns\\.net\$" type=FWD forward-to=$dnsCN comment="CNListDomain:Apple"
